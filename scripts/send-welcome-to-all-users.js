...
async function sendWelcomeEmailsToAllUsers() {
    try {
        ...
        console.log('\n🔍 Fetching users with email addresses from database...');
        ...
        console.log(`📊 Found ${users.length} users with verified email addresses`);
...
if (require.main === module) {
    ...
    console.log('📧 Make sure you have configured SMTP properly in your .env file');
    console.log('----------------------------------------');
    ...
    rl.question('Are you sure you want to send welcome emails to ALL users? (yes/no): ', (answer) => {
    ...
    module.exports = { sendWelcomeEmailsToAllUsers };
}