...
const schemas = {
   ...
   */
  provider: Joi.string()
    .valid('daimo', 'epayco', 'stripe')
    .required()
    .messages({
      'any.only': 'Payment provider must be one of: daimo, epayco, stripe',
  ...
  createPayment: Joi.object({
    ...
    provider: Joi.string().valid('daimo', 'epayco', 'stripe').required(),
  ...
  paymentQuery: Joi.object({
    ...
    provider: Joi.string().valid('daimo', 'epayco', 'stripe').optional(),
