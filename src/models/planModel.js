  ...
  static getDefaultPlans() {
    return [
      ...
      },
      {
        ...
        duration: 30,
        features: [
          '🔥 Videorama: All the smoke you want',
          '📍 Who is Nearby - connect with real papis',
          '🎥 3 Hangouts per month with the crew',
          '💬 Priority support from the team',
        ],
        featuresEs: [
          '🔥 Videorama: Todo el humo que quieras',
          '📍 Quién está Cerca - conecta con papis reales',
          '🎥 3 Hangouts al mes con la crew',
      ...
      },
      {
        ...
        features: [
          ...
          '🎥 5 Hangouts monthly - join the party',
        ...
        featuresEs: [
          ...
          '🎥 5 Hangouts al mes - únete a la fiesta',
      ...
      {
        id: 'six_months_pass',
        sku: 'EASYBOTS-PNP-180',
        name: 'Six Months Pass',
        nameEs: 'Pase Semestral',
        price: 74.99,
        currency: 'USD',
        duration: 180,
        features: [
