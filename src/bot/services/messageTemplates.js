    ...
    try {
      ...
      if (language === 'es') {
        return [
          ...
          '• PNP Latino Live – Transmisiones en vivo y grabaciones exclusivas',
          '',
        ...
        return [
          ...
          '• PNP Latino Live – Live streams and exclusive recordings',
          '',
          '📋 *Purchase Details:*',
          `• Plan: ${planName}`,
          amountLine.trim(),
  ...
  static buildLifetime100PromoMessage(language = 'es') {
    if (language === 'es') {
      ...
      return [
        ...
        '',
        '• *PNP Latino Live* – Live shows, special sessions, and exclusive recordings',
        '',
        '📢 *Important notice*',
        '',
